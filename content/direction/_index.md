...
- **[Big Picture Event Storming](/ubiq/#big-picture-event-storming):** Map [domain events](/ubiq/#domain-event), [commands](/ubiq/#command), [actors](/ubiq/#actor), [pain points](/ubiq/#pain-point). Use when the team does not share a mental model of the [domain](/ubiq/#domain).
- **[Context Mapping](/ubiq/#context-mapping):** Identify [bounded contexts](/ubiq/#bounded-context) and their relationships. Use when service boundaries are unclear or teams overlap.
- **[Aggregate Design](/ubiq/#aggregate-design):** Define consistency boundaries. Use when data integrity problems surface.

These techniques produce **[observations](/ubiq/#observation)**. Observations can become [Issues](/ubiq/#issue), but there is no requirement to link every observation to an Issue. If a problem is obvious without Event Storming, do not waste time storming to justify it.
