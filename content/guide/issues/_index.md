...
Issues bridge [Direction](/reference/ubiq/#direction) and [Work Items](/reference/ubiq/#work-item). Direction says "what we want to do." Issues say "what specifically stands in the way." Work Items say "how we resolve it."
...
When the team decides to act on an Issue, it becomes a [Work Item](/reference/ubiq/#work-item):

| Issue Resolution | Work Item |
|-----------------|-----------|
| Needs investment, multiple cycles | **[Feature](/reference/ubiq/#feature)** on the [roadmap](/reference/ubiq/#roadmap) |
| Small, one-cycle slice | **[Story](/reference/ubiq/#story)** in the current cycle |
| Unknown blocks resolution | **[Study](/reference/ubiq/#study)** to investigate |
...
[Production data](/reference/ubiq/#production-data), [user behaviour](/reference/ubiq/#user-behavior), monitoring alerts, [stakeholder](/reference/ubiq/#stakeholder) input, and team pain points all produce Issues. This closes the loop:
