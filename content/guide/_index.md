...
2. **[Feedback](/reference/ubiq/#feedback) is the only ground truth.** [Production data](/reference/ubiq/#production-data), [user behaviour](/reference/ubiq/#user-behavior), and [team sentiment](/reference/ubiq/#team-sentiment) override any plan.
3. **[Process](/reference/ubiq/#process) has cost.** Every [gate](/reference/ubiq/#gate), output [review](/reference/ubiq/#review), and meeting consumes energy. If a process element does not earn more than it costs, remove it.
4. **[Unknowns](/reference/ubiq/#unknowns) kill delivery.** Find them early. [Study](/reference/ubiq/#study) before you commit.
...
7. **[Judgment over rules](/reference/ubiq/#judgment-over-rules).** No rule applies in all contexts. The team decides when to follow, bend, or break any practice here.
...
| **[Working software](/reference/ubiq/#working-software) over comprehensive documentation** | [Use Cases](/reference/ubiq/#use-case) are structured but skippable. [Feature flags](/reference/ubiq/#feature-flag) decouple deploy from release. [Friction budget](/reference/ubiq/#friction-budget) caps process at 20%. The only ground truth is shipped, running software. |
| **Customer collaboration** over contract negotiation | [Direction](/reference/ubiq/#direction) revises based on [production data](/reference/ubiq/#production-data), not contracts. [Demo](/reference/ubiq/#demo) sessions show what shipped. [Prioritisation](/reference/ubiq/#prioritization) is conversation, not formula. |
| **Responding to change** over following a plan | Direction is revisable. [Roadmap](/reference/ubiq/#roadmap) changes freely. [Delivery cycle](/reference/ubiq/#delivery-cycle) has no fixed duration. Conditions for breaking process are explicit. |
...
- **Business people and developers work together daily.** Anyone on the team can talk to a [stakeholder](/reference/ubiq/#stakeholder) or user directly. No [gatekeepers](/reference/ubiq/#gatekeeper). No ticket-forwarding.
- **[Face-to-face conversation](/reference/ubiq/#face-to-face-conversation) is the most efficient method.** When the team is co-located, favour conversation over tickets. When remote, favour synchronous calls over threaded decision-making for resolving ambiguity.
...
- One [Mission](/reference/ubiq/#missions). What the team works towards now.
- One [Goal](/reference/ubiq/#goals). The next concrete outcome.
- An [Issues](/reference/ubiq/#issue) backlog. Capture everything. Triage continuously.
