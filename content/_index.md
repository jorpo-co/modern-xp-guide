...
2. **[Feedback](/ubiq/#feedback) is the only ground truth.** [Production data](/ubiq/#production-data), [user behavior](/ubiq/#user-behavior), and [team sentiment](/ubiq/#team-sentiment) override any plan.
...
| **Customer collaboration** over contract negotiation | [Direction](/ubiq/#direction) revises based on [production data](/ubiq/#production-data), not contracts. [Demo](/ubiq/#demo) sessions show what shipped. [Prioritization](/ubiq/#prioritization) is conversation, not formula. |
...
- **[Face-to-face conversation](/ubiq/#face-to-face-conversation) is the most efficient method.** When the team is co-located, favor conversation over tickets. When remote, favor synchronous calls over threaded decision-making for resolving ambiguity.
