...
| Level | Meaning | [First Response](/reference/ubiq/#first-response) | [Fix Target](/reference/ubiq/#fix-target) |
|-------|---------|---------------|------------|
...
Write a [runbook](/reference/ubiq/#runbook) for any incident type the team expects to meet again. The team decides when one is needed.
...
Do not use the same [SLO](/reference/ubiq/#slo-service-level-objective) for every service. A batch job has different targets than an API.

## On-call Rotation Template

| Element | Recommendation |
|---------|---------------|
| [Rotation](/reference/ubiq/#rotation) length | 1 week |
| Team size per rotation | Minimum 2 (primary + [secondary](/reference/ubiq/#on-call)) |
| Secondary escalation | Names a person, not a team |
| [Handover](/reference/ubiq/#rotation) | 15-minute sync at rotation change. Review open incidents and known issues. |
...
- [ ] [Logs](/reference/ubiq/#logs) are collected and searchable
- [ ] [Metrics](/reference/ubiq/#metrics) are collected and visible on the team dashboard
- [ ] Alerts exist for likely failure modes
- [ ] Deploy process is documented and repeatable
- [ ] [Rollback](/reference/ubiq/#rollback-plan) process is documented and tested
...
- [ ] [Runbook](/reference/ubiq/#runbook) exists for known failure modes
