...
<a id="blueprint"></a>
**Blueprint**
: Deployment strategy family: switching traffic between environments. See [Blue-green Deployment](/reference/ubiq/#blue-green-deployment), [Canary Deployment](/reference/ubiq/#canary-deployment), and [Rolling Deployment](/reference/ubiq/#rolling-deployment).
...
: See [Aggregate](/reference/ubiq/#aggregate) and [Aggregate Boundary](/reference/ubiq/#aggregate-boundary).
...
**Decision Record**
: See [ADR](/reference/ubiq/#adr-architecture-decision-record).
...
: See [Monitoring](/reference/ubiq/#monitoring).
